...
/**
 * @ClassName Respace_For_Offer_17_13
...
//        在处理标点符号和大小写之前，你得先把它断成词语。当然了，你有一本厚厚的词典dictionary，不过，有些词没在词典里。假设文章用sentence表示，设计一个算法，把文章断开，
...
public class Respace_For_Offer_17_13 {
    ...
    public int respace_2(String[] dictionary, String sentence) {
