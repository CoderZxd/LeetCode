...
public class CloneGraph_133 {
    ...
    private Map<NodeGraph, NodeGraph> visited = new HashMap<>();
    public NodeGraph cloneGraph(NodeGraph node) {
        ...
        NodeGraph cloneNode = new NodeGraph(node.val, new ArrayList());
        // 哈希表存储
