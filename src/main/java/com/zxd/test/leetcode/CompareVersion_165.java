...
//        System.out.println(compareVersion_165.compareVersion("1.01","1.001"));
//        System.out.println(compareVersion_165.compareVersion("1.0","1.0.0"));
//        System.out.println(compareVersion_165.compareVersion("1.0.1","1"));
        System.out.println(compareVersion_165.compareVersion("7.5.2.4","7.5.3"));
    }

    public int compareVersion(String version1, String version2) {
        String[] versionOne = version1.split("\\.");
        String[] versionTwo = version2.split("\\.");
        int max = Math.max(versionOne.length,versionTwo.length);
        for(int i=0;i<max;i++){
            int v1 = 0,v2 = 0;
    ...
    /**
     * @Author zouxiaodong
     * @Description 双指针：在分割版本号的同时解析出修订号进行比较
