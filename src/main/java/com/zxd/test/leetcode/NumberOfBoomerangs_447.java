...
public class NumberOfBoomerangs_447 {
    ...
    public static void main(String[] args) {
        NumberOfBoomerangs_447 numberOfBoomerangs_447 = new NumberOfBoomerangs_447();
        int[][] points = new int[][]{{1,1},{2,2},{3,3}};
        System.out.println(numberOfBoomerangs_447.numberOfBoomerangs(points));
    }
