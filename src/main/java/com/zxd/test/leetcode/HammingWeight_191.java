...
public class HammingWeight_191 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(hammingWeight_191.hammingWeight(1));
        System.out.println(hammingWeight_191.hammingWeight(11));
        System.out.println(hammingWeight_191.hammingWeight(128));
        System.out.println(hammingWeight_191.hammingWeight(-3));
    }
