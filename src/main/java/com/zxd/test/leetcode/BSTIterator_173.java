...
public class BSTIterator_173 {
    ...
    public static void main(String[] args) {
        ...
        TreeNode root_r = new TreeNode(15);
        TreeNode root_r_l = new TreeNode(9);
        TreeNode root_r_r = new TreeNode(20);
        root_r.left = root_r_l;
        root_r.right = root_r_r;
        root.left = root_l;
        root.right = root_r;
        BSTIterator_173 bstIterator_173 = new BSTIterator_173(root);
        System.out.println(bstIterator_173.next());
        System.out.println(bstIterator_173.next());
        System.out.println(bstIterator_173.hasNext());
        System.out.println(bstIterator_173.next());
        System.out.println(bstIterator_173.hasNext());
        System.out.println(bstIterator_173.next());
        System.out.println(bstIterator_173.hasNext());
