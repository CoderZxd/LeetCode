...
public class ParkingSystem_1603 {
    ...
    public ParkingSystem_1603(int big, int medium, int small) {
        this.big=new int[]{big,medium,small};
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(parkingSystem_1603.addCar(1));
        System.out.println(parkingSystem_1603.addCar(2));
        System.out.println(parkingSystem_1603.addCar(3));
        System.out.println(parkingSystem_1603.addCar(1));
    }
}
/**
