...
//        System.out.println(chalkReplacer_1894.chalkReplacer(new int[]{5,1,5},22));
//        System.out.println(chalkReplacer_1894.chalkReplacer(new int[]{3,4,1,2},25));
        System.out.println(chalkReplacer_1894.chalkReplacer(new int[]{2,2,3},1));
    }

    /**
     * @Author zouxiaodong
     * @Description 前缀和
     * @Date 2021/09/10 14:53
     * @Param [chalk, k]
     * @return int
     **/
